...
<div id="thenego" class="mt-5">
      <div id="valprop" class="justify-content-around">
       <input class="font-weight-bold" type="text" id="validationCustom07" placeholder="Entrez une proposition" required>
...
<div id="containerparam" class="col-9 pb-5 pt-4 rounded text-center" >
    <button id="ixi" class="btn float-right">&#10060;</button>
...
<div class="card text-white bg-secondary mt-4 col-5" id="confirm">
    <div class="card-body">
