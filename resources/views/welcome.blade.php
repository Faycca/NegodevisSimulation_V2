...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div id="fond_header">
            <nav id="header" class="navbar navbar-expand-lg navbar-dark pt-3">
         ...
         <div id="button" class="btn-group btn-group-toggle rounded-pill border border-white col-2 p-1 mr-3" data-toggle="buttons">
            <button type="button" class="btn btn-link btn-sm text-decoration-none text-white">CONNEXION</button>
               <div class="border-right border-white"></div>
                  <button type="button" class="btn btn-link btn-sm text-decoration-none text-white">INSCRIPTION</button>
         </div>
            </nav>
